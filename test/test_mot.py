...
def main(opt, data_root='/data/MOT16/train', det_root=None, seqs=('MOT16-05',), exp_name='demo', 
    ...
    for seq in seqs:
        output_dir = os.path.join('results/mot', exp_name, 'qualitative', seq) if save_images or save_videos else None

        logger.info('start seq: {}'.format(seq))
        dataloader = videodataset.LoadImagesAndObs(osp.join(data_root, seq, 'img1'), opt)
...
if __name__ == '__main__':
    ...
    if not opt.test_mot16:
        ...
        #             CVPR19-05'''
        #seqs_str = '''CVPR19-01'''
        #data_root = '/home/wangzd/datasets/MOT/MOT19/images/train'
        seqs_str = '''MOT16-01
                     MOT16-03
                     MOT16-06
                     MOT16-07
